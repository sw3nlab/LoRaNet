...
**0)** Припаиваем к LoRa модулям USB TTL UART конвертеры и подключаем к компуктерам

**1)** Конфигурируем дефолтной утилитой ebyte (https://www.ebyte.com/en/data-download.html?id=199&pid=196#load), выставляем одинаковые параметры, (канал,мощность,скорость и т.д)
...
**5)** добавляем конфиг в `/etc/network/interfaces`на Raspberry Pi
